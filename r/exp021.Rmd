...
#parameter#1: od / comp_dil
#parameter#2: plate 1 / palte 2
#parameter#3: strain
...
path_results <- file.path(root, "data-raw/2019-5-24_exp021", "results_021_saureus.csv")
path_parameters <- file.path(root, "data-raw/2019-5-24_exp021", "parameters_021.xlsx")
...
df_parameters <- dplyr::filter(df_parameters, strain != "ecoli 227" )

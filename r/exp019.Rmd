...
path_results <- file.path(root, "data-raw/exp019", "results_019.csv")
path_parameters <- file.path(root, "data-raw/exp019", "parameters_019.xlsx")
...
# sum_countcomp <- df_filtered %>%
#                     group_by(od, comp_dil, compound) %>%
#                     summarize( 
#                           countcomp = n()
#                     )
# 
# df_filtered <- sum_countcomp %>%
#       select (countcomp, comp_dil, od, compound) %>%
#       left_join(df_filtered, by = c("comp_dil","od","compound"))
